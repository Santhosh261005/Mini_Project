...
predefined_responses = {
    ...
    "website details": "Our platform, Campus-Connect, Created by Rithwik and Santhosh connects students with underprivileged communities, allowing them to donate essential items seamlessly.",
