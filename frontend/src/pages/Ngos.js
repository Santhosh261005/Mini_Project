        ...
        <div className="p-6">
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-6">
            ...
            <div className="w-full md:w-48">
              <select
                className="block w-full pl-3 pr-10 py-2 border border-gray-300 rounded-lg bg-gray-50 focus:ring-emerald-500 focus:border-emerald-500"
                  ...
                  {expandedNgo === ngo.id && (
                    <div className="px-4 pb-4 pt-2 bg-gray-50 border-t">
                      ...
                      <div className="mt-4 flex space-x-3">
                        <Link
                          to="/donate"
                          className="flex-1 bg-emerald-600 text-white px-4 py-2 rounded-lg hover:bg-emerald-700 transition-colors text-center"
                        >
                          Donate Now
                        </Link>
                        <button className="flex-1 bg-white border border-emerald-600 text-emerald-600 px-4 py-2 rounded-lg hover:bg-emerald-50 transition-colors">
                          Learn More
                        </button>
                      </div>
                    </div>
